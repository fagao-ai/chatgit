  ...
  <div class="h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 flex">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <div class="p-4 bg-gray-800 border-t border-gray-700">
        <form @submit.prevent="handleSubmit" class="max-w-4xl mx-auto relative">
          <input
            v-model="inputUrl"
            type="text"
            :placeholder="currentChat?.hasMessage ? '请输入问题...' : '请输入GitHub项目URL...'"
            class="w-full pl-6 pr-24 py-4 bg-gray-900 text-gray-100 rounded-xl border border-gray-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
          />
          <button
            type="submit"
            :disabled="isLoading"
            class="absolute right-2 top-2 bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-2 rounded-lg text-white hover:opacity-90 disabled:opacity-50 transition-opacity flex items-center"
          >
